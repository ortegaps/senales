...
class Base:
    ...
    # Conexiones
        ...
        self.scrolled_informativas.set_policy(
        ...
        self.scrolled_preventivas.set_policy(
            Gtk.PolicyType.AUTOMATIC, Gtk.PolicyType.AUTOMATIC)
        ...
        self.scrolled_reglamentarias.set_policy(
            Gtk.PolicyType.AUTOMATIC, Gtk.PolicyType.AUTOMATIC)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/aeropuerto.gif', 24, 24)
        ...
        balneario = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/balneario.gif', 24, 24)
        ...
        bar = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/bar.gif', 24, 24)
        ...
        css = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/camino-o-calle-sin-salida.gif', 24, 24)
        ...
        css2 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/camino-o-calle-sin-salida2.gif', 24, 24)
        ...
        pt = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/paso1.gif', 24, 24)
        ...
        pt2 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/paso2.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/campamento.gif', 24, 24)
        ...
        cda = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/comienzo-de-autopista.gif', 24, 24)
        ...
        cdab.connect(
            ...
            salir,
            win,
            'comienzo_de_autopista')
        # correo
        correo = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/correo.gif', 24, 24)
        ...
        dcs = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/desvio-por-cambio-de-sentid.gif', 24, 24)
        ...
        dcsb.connect(
            ...
            salir,
            win,
            'desvio_por_cambio_de_sentido')
        # direcciones permitidas
        dp1 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/direccione2s-permitidad-igu.gif', 24, 24)
        ...
        dp2 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/direcciones-permitidad-am-s.gif', 24, 24)
        ...
        dp2b.connect(
            ...
            salir,
            win,
            'direcciones_permitidas2')
        # direcciones permitidas3
        dp3 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/direcciones-permitidad-bifu.gif', 24, 24)
        ...
        dp3b.connect(
            ...
            salir,
            win,
            'direcciones_permitidas3')
        # direcciones permitidas4
        dp4 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/direcciones-permitidad-dere.gif', 24, 24)
        ...
        dp4b.connect(
            ...
            salir,
            win,
            'direcciones_permitidas4')
        # direcciones permitidas5
        dp5 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/direcciones-permitidad-igua.gif', 24, 24)
        ...
        dp5b.connect(
            ...
            salir,
            win,
            'direcciones_permitidas5')
        # direcciones permitidas6
        dp6 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/direcciones-permitidad-izqu.gif', 24, 24)
        ...
        dp6b.connect(
            ...
            salir,
            win,
            'direcciones_permitidas6')
        # esquema de recorrido
        edr = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/esquema-de-recorrido.gif', 24, 24)
        ...
        estacion = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/estacion-de-ferrocarril.gif', 24, 24)
        ...
        estacionb.connect(
            ...
            salir,
            win,
            'estacion_de_ferrocarril')
        # estacion de servicio
        estacion2 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/estacion-de-servicio.gif', 24, 24)
        ...
        fina = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/fin-de-autopista.gif', 24, 24)
        ...
        gomeria = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/gomeria.gif', 24, 24)
        ...
        hotel = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/hotel.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/indicadore-de-utilizacion-d.gif', 24, 24)

        indicadores.set_from_pixbuf(pixbuf)
        indicadoresb = Gtk.Button()
        indicadoresb.add(indicadores)
        indicadoresb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
            win,
            'indicadore-de-utilizacion-d')
        # lugar para recreacion y descanso
        recreacion = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/lugar-para-recreacion-y-des.gif', 24, 24)
        ...
        museo = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/museo.gif', 24, 24)
        ...
        parada = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/parada.gif', 24, 24)
        ...
        pgd = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/permitido-girar-derecha.gif', 24, 24)
        ...
        pgi = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/permitido-girar-izquierda.gif', 24, 24)
        ...
        playa = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/playa.gif', 24, 24)
        ...
        plaza = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/plaza.gif', 24, 24)
        ...
        policia = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/policia.gif', 24, 24)
        ...
        ps = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/puesto_sanitario.gif', 24, 24)
        ...
        pp = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/punto-panoramico.gif', 24, 24)
        ...
        mecanico = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/servicio-mecanico.gif', 24, 24)
        ...
        telefono = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/servicio-telefonico.gif', 24, 24)
        ...
        taxi = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/taxi.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/teleferico.gif', 24, 24)
        ...
        terminal = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/terminal-de-omnibus.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/informativas/velocidades-maximas-permiti.gif', 24, 24)

        velocidades.set_from_pixbuf(pixbuf)
        velocidadesb = Gtk.Button()
        velocidadesb.add(velocidades)
        velocidadesb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
            win,
            'velocidades-maximas-permiti')
        ...
        altural = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/altura-limitada.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/ambulancia.gif', 24, 24)
        ...
        anchol = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/ancho-limitado.gif', 24, 24)
        ...
        asc = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/animales-sueltos-ciervos.gif', 24, 24)
        ...
        asv = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/animales-sueltos-vaca.gif', 24, 24)
        ...
        cd = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/calzada-dividida.gif', 24, 24)
        ...
        cr = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/calzada-rezbaladiza.gif', 24, 24)
        ...
        caminos = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Camino-sinuoso.gif', 24, 24)
        ...
        ciclista = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/ciclista.gif', 24, 24)
        ...
        corredora = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/corredor-aereo.gif', 24, 24)
        ...
        curvac = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Curva(comun).gif', 24, 24)
        ...
        curvaens = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Curva-en-S.gif', 24, 24)
        ...
        derrumbes = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/derrumbes.gif', 24, 24)
        ...
        enbi = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/encricijada-bifurcacion.gif', 24, 24)
        ...
        enbi2 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/encricijada-bifurcacion2.gif', 24, 24)
        ...
        enem = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/encricijada-empalme.gif', 24, 24)
        ...
        encr = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/encrucijada-cruce.gif', 24, 24)
        ...
        escolares = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/escolares.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Estrechamient(unasolamano).gif', 24, 24)

        estrechamientom.set_from_pixbuf(pixbuf)
        estrechamientomb = Gtk.Button()
        estrechamientomb.add(estrechamientom)
        estrechamientomb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
            win,
            'Estrechamient(unasolamano)')
        # Estrechamiento(dosmanos)
        estrecho = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Etrechamiento(dosmanos).gif', 24, 24)
        ...
        estrechob.connect(
            ...
            salir,
            win,
            'Etrechamiento(dosmanos)')
        # flecha-direccional
        flechad = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/flecha-direccional.gif', 24, 24)
        ...
        flechad2 = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/flecha-direccional2.gif', 24, 24)
        ...
        incor = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/incorporacion-de-transito-l.gif', 24, 24)
        ...
        jinete = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/jinete.gif', 24, 24)
        ...
        Ninos = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Ninos.gif', 24, 24)
        ...
        paso = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/paso.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Perfilirregular.gif', 24, 24)
        ...
        presencia = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/presencia-de-tranvia.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/proyeccion-de-piedras.gif', 24, 24)
        ...
        rotonda = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/rotonda.gif', 24, 24)
        ...
        semaforoo = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/semaforo.gif', 24, 24)
        ...
        tractor = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/tractor.gif', 24, 24)
        ...
        tunel = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/tunel.gif', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/circulacion_exlusiva_peatones.png', 24, 24)

        circulacion_exlusiva_peatones.set_from_pixbuf(pixbuf)
        circulacion_exlusiva_peatonesb.add(circulacion_exlusiva_peatones)
        circulacion_exlusiva_peatonesb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
            win,
            'circulacion_exlusiva_peatones')
        # circulaion_exlusica_bicicletas
        circulaion_exlusica_bicicletas = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/circulaion_exlusica_bicicletas.png', 24, 24)
        ...
        circulaion_exlusica_bicicletasb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/circulaion_exlusica_jinetes.png', 24, 24)
        ...
        circulaion_exlusica_jinetesb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/circula_colectivo.png', 24, 24)
        ...
        circulaion_exlusica_transpublicob.connect(
            'clicked', self.detalle, conociendo, salir, win, 'circula_colectivo')
        # circulaion_exlusiva_motos
        circulaion_exlusiva_motos = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/circulaion_exlusiva_motos.png', 24, 24)
        ...
        circulaion_exlusiva_motosb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/contramano.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/estacionamiento_exclusivo.png', 24, 24)
        ...
        estacionamiento_exclusivob.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limitacion_de_altura.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limitacion_de_ancho.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limitacion_de_largo_de_vehiculo.png', 24, 24)
        ...
        limitacion_de_largo_de_vehiculob.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limitacion_de_peso.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limitacion_de_peso_2.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limite_de_velocidad_maxima.png', 24, 24)
        ...
        limite_de_velocidad_maximab.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/limite_de_velocidad_minima.png', 24, 24)
        ...
        limite_de_velocidad_minimab.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_avanzar.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_estacionar.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_estacionar_ni_detenerse.png', 24, 24)
        ...
        no_estacionar_ni_detenerseb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_girar_a_la_derecha.png', 24, 24)
        ...
        no_girar_a_la_derechab.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_girar_a_la_izquierda.png', 24, 24)
        ...
        no_girar_a_la_izquierdab.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_girar_en_u.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/no_ruido_molesto.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_cambiar_de_carril.png', 24, 24)
        ...
        prohibicion_de_cambiar_de_carrilb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_acoplado.png', 24, 24)
        ...
        prohibicion_de_circular_acopladob.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_animal.png', 24, 24)
        ...
        prohibicion_de_circular_animalb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_autos.png', 24, 24)
        ...
        prohibicion_de_circular_autosb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_camion.png', 24, 24)
        ...
        prohibicion_de_circular_camionb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_motos.png', 24, 24)
        ...
        prohibicion_de_circular_motosb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_peaton.png', 24, 24)
        ...
        prohibicion_de_circular_peatonb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_trac.an.png', 24, 24)
        ...
        prohibicion_de_circular_tracanb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibicion_de_circular_tractor.png', 24, 24)
        ...
        prohibicion_de_circular_tractorb.connect(
            'clicked',
            self.detalle,
            conociendo,
            salir,
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/reglamentarias/prohibido_adelantar.png', 24, 24)
        ...
        Atencion = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Atencion.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Cruce_de_Peatoes.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Cruce_ferrioviario.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Curva_Cerrada.png', 24, 24)
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'images/preventivas/Cuz_de_San_Andres.png', 24, 24)
    ...
    def detalle(self, boton, conociendo, salir, win, data):
        for conociendo in win.get_children():
    ...
    def volver(self, win, detalle, conociendo):
        for detalle in win.get_children():
            win.remove(detalle)
        win.add(conociendo)
        win.show_all()

    def exit(self, win, vbox, menu):
        for vbox in win.get_children():
            win.remove(vbox)
        win.add(menu)
        win.show_all()

    def salir1(self, win, menu, historia):
        for historia in win.get_children():
            win.remove(historia)
        win.add(menu)
        win.show_all()
    ...
    def futurista(self, menu, win, ram, conociendo):
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            parser.get('historia' + str(ram), 'image'), 400, 400)
    ...
    def initi(self, sabes, win, menu):
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size(
            self.parser.get('pregunta' + str(self.numero), 'imagen'), 400, 400)
